...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
	...
	<%@ include file="../common/gnb.jsp" %>
		...
		<div class="contents-wrap">
			<h1 class="menu-title">쿠폰 관리 > 쿠폰 영업정보 대사건 조회</h1>
			...
			<div class="list-top">
				<ul class="inline-list">
					<li on-click="compareEqualCp" id="copyCpBtn" style="cursor: pointer">대사조정처리</li>
				</ul>
			</div>
	...
	<script src="/js/app/coupon/ACPNW026.js" type="text/javascript"></script>
