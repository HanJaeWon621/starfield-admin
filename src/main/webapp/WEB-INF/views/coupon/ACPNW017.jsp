...
aaa=<labal id="chkTenant"></labal>
			...
			<table>
				<tr> 
					...
					<tr>
						...
						<td> 
							<input id="cp_kind_cd1" type="radio" name="{{cp_kind_cd}}" value="1" on-change="kindCdChange:{{'1'}}" >에누리 쿠폰 
							<input id="cp_kind_cd2" type="radio" name="{{cp_kind_cd}}" value="2" on-change="kindCdChange:{{'2'}}" >할인 쿠폰
						</td>
					</tr> 
					<tr> 
						<td>
					...
					<tr>
						<td>*사용처설정 :</td>
						<td> 
							 <input id="tenantAll" type="checkbox"  on-click="tenantAll" />
					...
					<tr>
						...
						<td>
							...
							<br/> 
							<br/>
							<img id="moblBiImg" src="\cdn\barcode\images\201606\5000\0120160601000000044.jpg" style="width: 50px;height: 50px">
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						<td>web</td>
						<td> 
							<input type="radio" id="webBg1" name="webBg" value="1" on-click="setWebBg:{{'img'}}" checked>
							<input type="file" id="webBgImg" >
							<br/>
							<br/>
							<input type="radio" id="webBg2" name="webBg" value="2" on-click="setWebBg:{{'color'}}">
						      현재색[<span id="webNowColor"></span>]
					...
					<tr>
						<td>mobile(APP)</td>
						<td> 
							<input type="radio" id="appBg1" name="appBg" value="1" on-click="setAppBg:{{'img'}}" checked>
							<input type="file" id="appBgImg" >
							<br/>
							<br/>
							<input type="radio" id="appBg2" name="appBg" value="2" on-click="setAppBg:{{'color'}}">
						      현재색[<span id="appNowColor"></span>]
	...
	<div id="dialog-detail" class="contents"  >
		...
		{{#tenantList:num}}
			<li class="list-body">
				<span style="width: 10%">
					<input id="tennant_{{tnt_seq}}" type="checkbox"  
						on-click="tennantChk:{{tnt_seq}},{{cate_nm_ko}},{{tnt_nm_ko}},{{room_num}},{{busi_tnt_cd}},{{img_main_bg_web_uri}},{{img_main_bg_mobi_uri}}">
				</span> 
	 ...
	 <div id="dialog-detail2" class="contents"  >
		...
		{{#selTenantList:num}}
			<li class="list-body" id="selTenant_{{tnt_seq}}"> 
				<span style="width: 25%">{{cate_nm_ko}}</span>
				<span style="width: 25%">{{tnt_nm_ko}}</span>
				<span style="width: 25%">{{room_num}}</span>
				<span style="width: 25%" on-click="deletetenant:{{tnt_seq}}">x</span> 
			</li>
		{{/selTenantList}}
		</ul> 
		{{/coupon}}
	...
	<script src="/js/app/coupon/ACPNW017.js" type="text/javascript"></script>
</body>
</html>