...
<style type="text/css">
	...
	<div id="coupon-reg" class="contents-area">
		<div class="contents-wrap">
			<h1 class="menu-title">쿠폰다운 내역상세</h1>
			...
			<table id="coupon-reg-info" class="input-list">
				...
				<tr>
					<th class="no-order">단말ID</th>
					<td class="no-order">
						<div class="text-input-wrap no-border">
							<input class="text-input" type="text" value="사용자 ID" value="{{uuid}}" disabled>
						</div>
					</td>
					<th class="no-order">다운로드 일시</th>
					<td class="no-order">
						<div class="text-input-wrap no-border"  >
							<input class="text-input" type="text"  value="단말 ID" value="{{cp_dn_dt}}" disabled>
						</div>
					</td>
				</tr>
			</table>
			<table id="coupon-reg-input" class="input-list">
				<tr>
					...
					<td>
						<div class="text-input-wrap no-border">
							<input class="text-input" type="text"  value="{{cp_div_cd_nm}}" disabled>
						</div>  
					</td> 
				</tr>
				<tr>
					...
					<td>
						<div class="text-input-wrap no-border">
							<input class="text-input" type="text"  value="{{cp_iss_bcd_id}} {{cp_iss_cd}}" disabled>
						</div>  
					</td> 
				</tr>
				<tr>
	...
	<script src="/js/app/coupon/ACPNW023.js" type="text/javascript"></script>
