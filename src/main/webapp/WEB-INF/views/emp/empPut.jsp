...
<body>
	<div id="emp-mod" class="contents">
		<script id="tmpl-emp-mod" type="text/ractive">
		<h3>사원 등록 수정</h3>
		{{#emp}}
			...
			<p>
				<input type="button" value="변경" on-click="modifyEmp" />
	...
	<script src="/js/app/emp/empPut.js" type="text/javascript"></script>
</body>
</html>