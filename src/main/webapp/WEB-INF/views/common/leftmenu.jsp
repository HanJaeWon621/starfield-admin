            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> 실내지도 관리 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="index.html">지점관리</a></li>
                      <li><a href="/01/map/floors">층관리</a></li>
                      <li><a href="/01/map/floorblocks">층별블록관리</a></li>
                      <li><a href="/01/map/tenents">INFO관리</a></li>
                      <li><a href="/01/styleSets">스타일셋트관리</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
