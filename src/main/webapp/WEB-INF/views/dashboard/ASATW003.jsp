...
<div id="dashboard-down" class="contents-area" data-bcn_cd="${bcn_cd}">
	<script id="tmpl-dashboard-down" type="text/ractive">
	<div class="contents-wrap">
		<h1 class="menu-title">DASHBOARD - 앱 다운로드 현황</h1>
		<div class="list-top">
			...
			<div class="inline-list">
				...
				<a class="basic-btn selected" href="/${bcn_cd}/dashboard/appdown">앱다운로드</a>
		...
		<div class="list-top">
			<ul class="inline-list">
				<li class="dashboard-result red">TOTAL DOWNLOADED <span class="red" id="tot_down_cnt">13056</span>명</li>
				<li><button type="button" on-click="excel">엑셀다운</button></li>
			</ul>
		</div>
		<div class="graph-check-wrap">
			
		</div>
		<div class="graph-area">
			<div id="chart-down" class="chart">
		</div>
	</div>
	</script>
</div>
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>
<script src="/js/app/dashboard/ASATW003.js" type="text/javascript"></script>
