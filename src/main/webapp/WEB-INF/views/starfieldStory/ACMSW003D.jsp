...
<div id="blog-reg" class="contents-area" data-bcn_cd="${bcn_cd}" data-thme_seq="${thme_seq}">
	<script id="tmpl-blog-reg" type="text/ractive">
	<div class="contents-wrap">
		<h1 class="menu-title">스타필드 스토리 관리 - 추천테마 관리 - 추천테마 등록 / 수정</h1>
		<table id="blog-reg" class="input-list">
			<tr>
				<th>추천테마 타이틀</th>
				<td>
					<div class="text-input-wrap">
						<input class="text-input" type="text" placeholder="추천테마 타이틀을 입력하세요" value="{{blog.thme_titl}}">
					</div>
				</td>
			</tr>
			<tr class="h92">
			...
			<tr>
				...
				<td>
					<div class="text-input-wrap">
						<input class="text-input" type="text" placeholder="https://www.starfield.co.kr/" value="{{blog.thme_link_url}}">
					</div>
				</td>
			</tr>
			<tr class="h92">
				<th>배경 이미지</th>
				<td>
					<div class="img-uploader {{#if blog.reps_img_seq}}after{{else}}before{{/if}}"><!-- before: 업로드전/ after: 업로드 후-->
...
<script src="/js/app/starfieldStory/ACMSW003D.js" type="text/javascript"></script>
