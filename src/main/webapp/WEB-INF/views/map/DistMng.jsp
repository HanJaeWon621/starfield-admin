...
<div class="container-fluid">
			...
			<div class="x_content">
                    <table class="table">
                      ...
                      <tbody>
						...
						<td>{{bcn_tel}}</td>                           
						<td><a  class="btn btn-info btn-sm"  on-click=saveMapFile:{{bcn_cd}}>데이터생성</a>&nbsp;
						<button class="btn btn-info btn-sm" on-click=makeMapFile:{{bcn_cd}}>데이터배포</button>
						</tr>
						{{/styleList}}
                      </tbody>
                    </table>
	...
	<script src="/js/app/map/DistMng.js" type="text/javascript"></script>
