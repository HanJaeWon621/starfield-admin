...
public class SOPR003Vo extends BaseVo {
	public String stf_irgu_opr_seq;
	...
	public StarFieldHoliday toModel() {
		StarFieldHoliday model = new StarFieldHoliday();
		
		model.stf_irgu_opr_seq = this.stf_irgu_opr_seq;
