...
@Controller
@RequestMapping("/")
public class TodoMngWebController {

	private Logger ll = LoggerFactory.getLogger(TodoMngWebController.class);

	@Autowired
	PgMngService service;

	// 스타일 세트 리스트
	@RequestMapping(value = "/todoMngs")
	...
	// 목록
	@RequestMapping(value = "/getTodoMngs/excel", method = RequestMethod.GET, produces = "application/vnd.ms-excel")
